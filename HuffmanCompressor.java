...
public class HuffmanCompressor {
    ...
    public void makeCode() throws IOException {
        ...
        System.out.println("\tNow, I am going to call your HuffmanCode(int[]) constructor using that frequency table.");
        HuffmanCode t = new HuffmanCode(count);

        System.out.println("\tOkay!  Now, I am going to save the code (using your save method) to the file " + filename + ".code!");
    ...
    public void compress(boolean debug) throws IOException {
        ...
        this.makeCode();
        System.out.println("\tNow that I have the Huffman Code, I am going to use the huffman code file created by");
    ...
    public void decompress(boolean printToConsole) throws IOException {
        ...
        if (!printToConsole) {
            System.out.println("\tNow, I will decompress the file and put it into a file using your translate() method.");
            output = new PrintStream(new File(this.filename + ".new"));
        }
        else {
            System.out.println("\tNow, I will decompress the file and display it on the console using your translate() method..."); 
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            System.out.print("Which file would you like to work with (it must be a txt file)? ");
        ...
        while (choice == -1) {
            ...
            System.out.println("\t(4) do a compression followed by a decompression");
        ...
        boolean debug = false;
        if (choice == COMPRESS) {
            System.out.print("Would you like to debug the compressed file (y/n)? ");
            debug = console.nextLine().trim().toLowerCase().startsWith("y");
        }

        boolean toConsole = false;
        if (choice == DECOMPRESS || choice == ROUND_TRIP) {
            System.out.print("Would you like to print the result to a file (y/n)? ");
            toConsole = !console.nextLine().trim().toLowerCase().startsWith("y");
        }
